...
stations = pd.read_csv('/raid2/wp280/PhD/reykjanes/nodes/msnoise-main/stations.csv')
json_pat = '/raid2/wp280/PhD/reykjanes/nodes/msnoise-main/picked_ridges_DEP.json'
out_path = '/raid2/wp280/PhD/reykjanes/nodes/DST/ReykjanesRawData'
